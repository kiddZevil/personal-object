define(['Util'
        ,'upload'
        ,'text!module/workflow/activity/games/gamesTab/gamesTab.tpl'
        ,'text!module/workflow/activity/games/gamesTab/gamesPrize.tpl'
        ,'text!module/workflow/activity/games/gamesTab/resBoxRadio.tpl'
        ,'text!module/workflow/activity/games/gamesTab/resConRadio.tpl'],
    function (Util,Upload,ldTabTpl,ldPrizeTpl,resBoxTpl,resConTpl) {
        ...
        var initialize = function(option,object){
            ...
            this.dataLen = option.dataLen; //编辑的时候已添加的奖项长度
            this.givprzType = option.givprzType; //派奖设置
            //编辑初始化tab页面
            if(option.object){
