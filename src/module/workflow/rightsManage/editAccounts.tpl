<!--title begin-->
<div class="con-title">
    <p><a href="javascript:;" id="G-back-parent">权限管理</a><span>&nbsp;&gt;&nbsp;编辑账号</span></p>
</div>
<!--title end-->
<!--右侧主体内容begin-->
    ...
    <div class="all_order right-edit">
        ...
        <input name="userId" id="userId" value="" type="hidden">
            ...
            <div class="control-group">
                ...
                <div class="controls controls disable-control">
                    <input class="account-name" type="text" name="account" disabled="" placeholder="请输入账号，4-20个字符组成" maxlength="20">

                </div>
                <div id="J-account-name_wrapper" class="error-tips fn-hide mt-15">
                    <p id="J-account-name" class="error"></p>
                </div>
            </div>
            <!--账号  end-->
            <!--昵称 beg-->
            <div class="control-group">
                ...
                <div class="controls controls">
                    <input class="account-als" type="text" name="userAls" placeholder="请输入账号，4-20个字符组成" maxlength="12">
                </div>
                <div id="J-account-name_wrapper" class="error-tips fn-hide mt-15">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input name="accPassword" class="accPassword" value="" type="password" placeholder="8-20位数字及字母组成">

                </div>
                <div id="J-password_wrapper" class="error-tips fn-hide mt-15">
                    <p id="J-password" class="error">请输入8-20位数字和字母组成的密码</p>
                </div>
            </div>
            <!--密码  end-->
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input name="rePassword" class="rePassword" value="" type="password" placeholder="再输一次密码" >
                </div>
