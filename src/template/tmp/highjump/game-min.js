    ...
    App = function(b) {
        ...
        c.prototype.onAddToStageHandler = function(b) {
            if (!c.stage) {
                ...
                if(flag === '0'){
                    RES.loadConfig("resource/resource.json", "resource/"); //配置资源
                }else if(givprzType === '02'){
                    RES.loadConfig("resource/resource.json", "resource/"); //配置资源---排名
                }else if(givprzType === '01'){
                    RES.loadConfig("resource/resource2.json", "resource/"); //配置资源---抽奖
                }
        ...
        c.prototype.setScore = function(b) {
            ...
            if(flag !== '0'){
                ...
                if(!Util.isLogin.login()){
                    ...
                    var param = {
                        'cmpgnId':cmpgnId,
                        'gameScore': Math.floor(this.score / 39),
                        'bgnGameTime':begTime,
                        'endGameTime':endTime
                    };
...
var __extends = this.__extends || function(b, c) {
    ...
    GameScreen = function(b) {
        ...
        c.prototype.gameStart = function() {
            ...
            var el = $('#btn_chick');
            el.click(function(){
                Log.trackEvent(['互动营销','跳高活动', cmpgnId,'1'], this); //统计刮奖次数
            });
            el.click();
            this.setScore(0);
